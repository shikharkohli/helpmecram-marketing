...
export function HeroSection() {
  return (
    <section className="hero-gradient min-h-screen pt-28 pb-16 px-4 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-5xl text-center z-10">
        <div className="inline-flex items-center px-3 py-1 rounded-full border border-border bg-background/50 backdrop-blur-sm mb-4 animate-fade-in">
          ...
          <span className="text-sm font-medium">Coming Soon — Join Our Waitlist</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 animate-fade-in" style={{ animationDelay: "800ms" }}>
          <div className="glass-effect rounded-lg p-6 text-left">
            <div className="flex items-start mb-2">
              <CheckCircle className="text-primary mr-2 h-5 w-5 mt-0.5" />
              <p className="font-medium">Scientifically-proven to improve retention by up to 300%</p>
            </div>
          </div>
          ...
          <div className="glass-effect rounded-lg p-6 text-left">
            <div className="flex items-start mb-2">
              <CheckCircle className="text-primary mr-2 h-5 w-5 mt-0.5" />
              <p className="font-medium">Personalized AI learning paths for all subjects</p>
            </div>
          </div>
          ...
          <div className="glass-effect rounded-lg p-6 text-left">
            <div className="flex items-start mb-2">
              <CheckCircle className="text-primary mr-2 h-5 w-5 mt-0.5" />
              <p className="font-medium">Suitable for all education levels and exam types</p>
            </div>
          </div>
        </div>
      </div>
